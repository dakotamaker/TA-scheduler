# Generated by Django 2.1.2 on 2018-11-18 08:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='TAScheduler.Account')),
                ('tas', models.ManyToManyField(blank=True, related_name='courses', to='TAScheduler.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Lab',
            fields=[
                ...
                ('ta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='TAScheduler.Account')),
            ],
        ),
    ]
