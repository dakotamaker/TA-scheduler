    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Account')),
                ('tas', models.ManyToManyField(related_name='courses', to='app.Account')),
            ],
        ),
        migrations.CreateModel(
            name='Lab',
            fields=[
                ...
                ('ta', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.Account')),
            ],
        ),
    ]
